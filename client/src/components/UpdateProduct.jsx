...
export default function UpdateProduct ( { updateProductData, updateModal, updatePage } ) {
    // console.log("updateProductData",updateProductData)
    const { _id, itemName, quantity, description, price, category, itemLevel } = updateProductData;
